...
def create
  ...
  redirect_to admin_sponsorrequest_path(@sponsorrequest), notice: "sponsor successfully added!"
  else
...
params.require(:sponsorrequest).permit(:company_name, :first_name, :last_name, :date, :comments, :spaces_available)
end
